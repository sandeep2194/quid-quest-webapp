...
import { MagnifyingGlassIcon, CogIcon, PlusIcon, Bars3Icon } from '@heroicons/react/24/solid';
...
export default function Employees() {
    ...
    return (
        <>
            <h2 className="text-2xl bg-green-950 text-center p-4 font-semibold text text-white">EMPLOYEES</h2>
            ...
            <div className="bg-gray-100 p-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="mb-4 flex flex-row md:justify-between">
                        ...
                        <Link href="employees/invite-employee">
                            <button className="hidden bg-[#2BB529] rounded-md text-white w-auto md:flex flex-row font-semibold text-xl p-2">+ Invite</button>
                        </Link>
                    </div>
