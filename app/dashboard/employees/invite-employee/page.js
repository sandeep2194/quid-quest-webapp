...
export default function InputName() {
    ...
    const [sent, set] = useState(true)

    return (
        <InputFieldModal>
            <div className="flex flex-col justify-centers space-y-6 px-6 py-10 m-4 lg:px-10 lg:py-16 rounded-xl shadow-xl w-full h-full">
                <h1 className="text-center text-2xl font-bold text-gray-800 mb-4">Invite Employee</h1>
                ...
                <div>
                    ...
                    {
                        fnError ? <EmptyFieldError errorMessage={"Enter the first Name"} /> : <></>
                    }
                </div>
                ...
                <div>
                    ...
                    {
                        lnError ? <EmptyFieldError errorMessage={"Enter the last Name"} /> : <></>
                    }
                </div>
                <div>
                    <StandardInputWIthLabel
                    ...
                    {
                        emailError ? <EmptyFieldError errorMessage={"Enter the email"} /> : <></>
                    }
                </div>
                <div>
