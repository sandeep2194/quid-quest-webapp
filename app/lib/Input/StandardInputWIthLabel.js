function StandardInputWIthLabel({ label, id, name, type = 'text', required = false, onChange }) {
    return (
        <div>
            <label htmlFor={id} className="block text-lg leading-6 text-gray-900 font-semibold">
                {label}
            </label>
            <div className="mt-2">
                <input
